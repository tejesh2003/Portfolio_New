  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6">
        ...
        >
          <span className="grid h-8 w-8 place-items-center rounded-lg grad-border glass text-sm text-gradient font-bold">TC</span>
          <span className="hidden sm:inline text-white/90">Tejesh<span className="text-gradient">.</span></span>
        </a>
