  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative w-full max-w-xl overflow-hidden rounded-3xl grad-border glass-strong animate-fade-up"
      >
        <div className="relative aspect-[16/8] bg-gradient-to-br from-indigo-500 via-fuchsia-500 to-cyan-400">
          ...
          <div className="pointer-events-none absolute inset-0 flex items-end p-8">
            <div>
              <div className="text-xs font-mono uppercase tracking-[0.25em] text-white/80">PDF · Updated 2026</div>
              <h3 className="mt-1 font-display text-4xl font-semibold text-white">Resume</h3>
            </div>
          </div>
        </div>
        <div className="bg-[#0b0b12] p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-500 to-indigo-500 px-5 py-2.5 text-sm font-medium text-white transition-transform hover:-translate-y-0.5"
            >
            ...
            <a
              ...
              download
              className="inline-flex items-center gap-2 rounded-full grad-border glass px-5 py-2.5 text-sm font-medium text-white transition-transform hover:-translate-y-0.5"
            >
